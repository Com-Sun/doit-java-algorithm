package com.nhnacademy.practice.chap07;
...
public class IntSet_07_01 {
    ...
    public boolean add(int n) {
        if (num >= max || contains(n)) // 가득 찼거나 이미 n이 존재합니다.
        {
            return false;
        } else {
    ...
    public void copyTo(IntSet_07_01 s) {
        ...
        if (n >= 0) System.arraycopy(set, 0, s.set, 0, n);
        s.num = n;
    }
    ...
    public void copyFrom(IntSet_07_01 s) {
        ...
        if (n >= 0) System.arraycopy(s.set, 0, set, 0, n);
        num = n;
    }
