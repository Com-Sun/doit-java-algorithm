package com.nhnacademy.practice.chap09;
...
public class LinkedListTTester_09_03 {
            ...
            switch (menu = SelectMenu()) {
                ...
                case RETRIEVE: { // 임의의 노드를 출력
                    ...
                    if (ptr == null) {
                        ...
                        System.out.println("데이터는 " + ptr + "입니다.");
                    }
                }
            }
    ...
    // 메뉴열거형
    public enum Menu {
        ADD_FIRST("머리에 노드를 삽입 "), ADD_LAST("꼬리에 노드를 삽입 "), RMV_FIRST("머리 노드를 삭제"),
        RMV_LAST("꼬리 노드를 삭제"), RMV_CRNT(
